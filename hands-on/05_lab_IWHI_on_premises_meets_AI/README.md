...
* For MCP/API test:  
    * **Mac & Linux: curl** available on the command line for OAuth and MCP validation calls (Mac & Linux). Use the bash commands from here: [05_lab_IWHI_on_premises_meets_AI/bash/](05_lab_IWHI_on_premises_meets_AI/bash/)
